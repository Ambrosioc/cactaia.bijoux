...
export default function CollectionPage() {
    ...
    const {
        ...
        collection: params.slug ? getCollectionFromSlug(params.slug as string) : undefined,
        searchTerm,
        sortBy,
        page: currentPage,
    ...
    // Mettre à jour le nom de la collection quand les paramètres changent
    useEffect(() => {
        if (params.slug) {
            ...
            <div className="bg-gradient-to-br from-primary/5 to-secondary/5 border-b">
                <div className="container-custom py-12">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="heading-lg mb-2">{collectionName}</h1>
