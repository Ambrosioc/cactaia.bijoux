/*
  # Migration finale pour corriger les politiques RLS de la table users
  
  Cette migration corrige définitivement la récursion infinie en utilisant
  une approche simple basée sur auth.jwt() au lieu de requêtes sur la table users.
*/
