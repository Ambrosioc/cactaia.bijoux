/*
  # Migration pour ajouter le champ updated_at à la table users
  
  Cette migration ajoute le champ updated_at manquant et recrée les triggers nécessaires.
*/

-- 1. Ajouter le champ updated_at s'il n'existe pas
DO $$ 
BEGIN
