/*
  # Migration pour corriger la récursion infinie dans les politiques RLS de la table users
  
  Le problème vient des politiques qui font référence à elles-mêmes ou créent des boucles.
  Cette migration supprime et recrée les politiques problématiques.
*/
